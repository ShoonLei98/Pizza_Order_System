                ...
                <div class="card-tools">
                    <form action="{{ route('admin#searchAdmin') }}" method="get">
                        ...
                        <div class="input-group input-group-sm" style="width: 150px;">
                            <input type="text" name="searchAdmin" class="form-control float-right" placeholder="Search" value="{{ Session::get('SEARCH_ADMIN') }}">
                  ...
                  <tbody>
                      @foreach ($admin as $item)
                        <tr>
                            ...
                            <td>{{ $item->address }}</td>
                            <td>
                            <a href="{{ route('admin#editAdmin', $item->id) }}">
                                <button class="btn btn-sm bg-dark text-white"><i class="fas fa-edit"></i></button>
                            </a>
                            <a href="{{ route('admin#deleteAdmin', $item->id) }}">
